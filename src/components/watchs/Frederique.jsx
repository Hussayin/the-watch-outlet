...
const Frederique = () => {
  ...
  if (!products?.Frederique || products.Frederique.length === 0)
    return <div>Longines mahsulotlari topilmadi.</div>;

  const filteredProducts = products?.Frederique?.filter((watch) => {
  ...
  return (
    <div>
      ...
      <div className="flex gap-[13px] border-t-[2px] border-white dark:bg-white bg-[#0f192b] p-[10px] overflow-x-scroll hide-scrollbar ">
        <button
