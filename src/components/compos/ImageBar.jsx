    ...
    <div className="mt-[0px] mb-[100px] text-white">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-[7px] p-2">
        ...
        <AnimatePresence>
          {selectedImage && (
            <motion.div
              className="fixed inset-0 bg-[#112544] z-[1111111111] flex items-center justify-center"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
            ...
            >
              <motion.div
                className="relative bg-[#0e1629] w-[99%]  justify-center p-2 rounded-lg shadow-lg"
                initial={{ scale: 0.8 }}
                animate={{ scale: 1 }}
                exit={{ scale: 0.8 }}
              ...
              >
                ...
                <img
                  ...
                  alt="Selected"
                  className=" w-[100%] object-cover m-auto border-[#9a9494] border-[2px] h-[500px] rounded-lg"
                />
